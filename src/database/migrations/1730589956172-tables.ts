...
export class Tables1730589956172 implements MigrationInterface {
    name = 'Tables1730589956172'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pedido_producto" ("id" SERIAL NOT NULL, "pedidoId" integer NOT NULL, "ProductoId" integer NOT NULL, "cantidad" integer NOT NULL, "productoId" integer, CONSTRAINT "PK_97f69aaf286bdd82afbd487e4d5" PRIMARY KEY ("id"))`);
